...
public class PaintBrush extends Applet implements ActionListener,MouseMotionListener,MouseListener{
    ...
    public void init() 
    {
        ...
        bEraser.setBounds(562,2,100,30);
        add(bEraser);
        ...
        bOpen.setFont(new Font("Courier",Font.BOLD,18));
        bOpen.setBounds(962,2,60,30);
        add(bOpen);
        ...
        try
        {
            ...
            for(int i=0;i<drawnShape.size();i++)
            {
                switch(drawnShape.elementAt(i))
                {
                    ...
                    case 'H':
                    {
                        g2d.setColor(handVec.get(hCounter).color);
